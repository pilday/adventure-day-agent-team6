...
functions = [
        {
        ...
        },
         {
            ...
            "function": {
                "name": "get_movie_year",
                "description": "Gets the year when the movie was released",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "title": {
            ...
            "function": {
                ...
                "description": "Gets the movie actor",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "title": {
        ...
        },
        {
            ...
            "function": {
                ...
                "description": "Gets the movie genre",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "title": {
